...
export default class extends BaseSeeder {
  async run() {
    ...
    await Produto.createMany([
      ...
      {nome: "Porção de Batata Frita", preco: 15, tamanho: "M", tipoId: 4},
      {nome: "Porção de Onion Rings", preco: 12, tamanho: "P", tipoId: 4},
      {nome: "Porção de Frango à Passarinho", preco: 18, tamanho: "G", tipoId: 4},
      {nome: "Porção de Mandioca Frita", preco: 14, tamanho: "M", tipoId: 4},
      {nome: "Porção de Polenta Frita", preco: 16, tamanho: "G", tipoId: 4}
